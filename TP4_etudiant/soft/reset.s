...
proc1:
        ...
        li      $27,	0x2221# TO BE COMPLETED		 IRQ_DMA, IRQ_IOC, IRQ_TIM[0] & IRQ_TTY[0]
...
proc2:
        ...
        li      $27,	0x4441# TO BE COMPLETED		 IRQ_DMA, IRQ_IOC, IRQ_TIM[0] & IRQ_TTY[0]
        #li  	$27,	0b0011000000 		# IRQ_TIM[2], IRQ_TTY[2]
        sw      $27,	8($26)

        # initializes stack pointer for PROC[2]
        la      $29,	seg_stack_base+4
...
proc3:
        ...
        li      $27,	0x8881# TO BE COMPLETED		 IRQ_DMA, IRQ_IOC, IRQ_TIM[0] & IRQ_TTY[0]
